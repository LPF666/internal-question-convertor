package com.eebbk.internal.question.convertor.exportjarserviceRebuild06;
...
public class UploadData8 {
	public static void main(String[] args) {
		...
		//本线程处理10260000-10440000万的数据，共5万数据量
		Integer handerStartIndex=10260000;
		Integer handerDataMaxIndex=10440000;
