package com.eebbk.internal.question.convertor.exportjarserviceRebuild05;
...
public class UploadData8 {
	public static void main(String[] args) {
		...
		//本线程处理8460000-8640000万的数据，共5万数据量
		Integer handerStartIndex=8460000;
		Integer handerDataMaxIndex=8640000;
