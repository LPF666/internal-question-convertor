package com.eebbk.internal.question.convertor.exportjarMathjyeQue;
...
public class UploadData6 {
	...
	public static void main(String[] args) {
		...
		//开始处理数据下标,本次处理
		Integer handerStartIndex=1500000;
		//每个线程处理30万数据量，每次处理2万的数据量
		Integer handerDataMaxIndex=1800000;
		//判断是试卷题还是非试卷题
		Integer tableFlag=0;
