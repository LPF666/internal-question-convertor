package com.eebbk.internal.question.convertor.exportjarservice02;
...
public class UploadData19 {
	public static void main(String[] args) {
		...
		//本线程处理2040000-2070000万的数据，共5万数据量
		Integer handerStartIndex=2040000;
		Integer handerDataMaxIndex=2070000;
