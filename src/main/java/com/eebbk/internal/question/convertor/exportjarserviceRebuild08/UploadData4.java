package com.eebbk.internal.question.convertor.exportjarserviceRebuild08;
...
public class UploadData4 {
	public static void main(String[] args) {
		...
		//本线程处理13140000-13320000万的数据，共5万数据量
		Integer handerStartIndex=13140000;
		Integer handerDataMaxIndex=13320000;
