package com.eebbk.internal.question.convertor.exportjarservice07;
...
public class UploadData50 {
	public static void main(String[] args) {
		...
		//本线程处理10470000-10500000万的数据，共5万数据量
		Integer handerStartIndex=10470000;
		Integer handerDataMaxIndex=10500000;
