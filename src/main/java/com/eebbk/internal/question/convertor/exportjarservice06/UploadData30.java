package com.eebbk.internal.question.convertor.exportjarservice06;
...
public class UploadData30 {
	public static void main(String[] args) {
		...
		//本线程处理8370000-8400000万的数据，共5万数据量
		Integer handerStartIndex=8370000;
		Integer handerDataMaxIndex=8400000;
