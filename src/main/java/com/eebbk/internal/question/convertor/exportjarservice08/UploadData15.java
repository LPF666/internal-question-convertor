package com.eebbk.internal.question.convertor.exportjarservice08;
...
public class UploadData15 {
	public static void main(String[] args) {
		...
		//本线程处理10920000-10950000万的数据，共5万数据量
		Integer handerStartIndex=10920000;
		Integer handerDataMaxIndex=10950000;
