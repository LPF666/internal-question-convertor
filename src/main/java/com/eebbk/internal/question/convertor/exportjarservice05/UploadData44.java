package com.eebbk.internal.question.convertor.exportjarservice05;
...
public class UploadData44 {
	public static void main(String[] args) {
		...
		//本线程处理7290000-7320000万的数据，共5万数据量
		Integer handerStartIndex=7290000;
		Integer handerDataMaxIndex=7320000;
