package com.eebbk.internal.question.convertor.exportjarserviceRebuild04;
...
public class UploadData5 {
	public static void main(String[] args) {
		...
		//本线程处理6120000-6300000万的数据，共5万数据量
		Integer handerStartIndex=6120000;
		Integer handerDataMaxIndex=6300000;
