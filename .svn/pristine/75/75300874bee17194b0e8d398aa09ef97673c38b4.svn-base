package com.eebbk.internal.question.convertor.exportjarservice10;
...
public class UploadData46 {
	public static void main(String[] args) {
		...
		//本线程处理14850000-14880000万的数据，共5万数据量
		Integer handerStartIndex=14850000;
		Integer handerDataMaxIndex=14880000;
