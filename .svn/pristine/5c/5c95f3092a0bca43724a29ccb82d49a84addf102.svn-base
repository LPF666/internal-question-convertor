...
<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$.ajax({
					type:"POST",
					url:"api/questionInfo/getCountsBySolution",
					data:null,
					datatype:"json",
...
<body>
	<div class="css_middle">
		<div class="css_nav">
			...
			<br><br>
			<div style="margin: 0 auto;color: black;font-weight: bold;text-align: center;">题目解析存在情况统计</div>
			<br>
			<div id="contentDiv" style="margin: 0 auto;width: 80%;color: black;">
			
			</div>	
			
			<div id="answerDiv" style="margin: 0 auto;width: 80%"">
