package com.eebbk.internal.question.convertor.exportjarservice04;
...
public class UploadData36 {
	public static void main(String[] args) {
		...
		//本线程处理5550000-5580000万的数据，共5万数据量
		Integer handerStartIndex=5550000;
		Integer handerDataMaxIndex=5580000;
