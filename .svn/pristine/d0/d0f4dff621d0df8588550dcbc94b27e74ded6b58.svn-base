package com.eebbk.internal.question.convertor.exportjarserviceRebuild10;
...
public class UploadData8 {
	public static void main(String[] args) {
		...
		//本线程处理17460000-17640000万的数据，共5万数据量
		Integer handerStartIndex=17460000;
		Integer handerDataMaxIndex=17640000;
