package com.eebbk.internal.question.convertor.exportjarserviceRebuild01;
...
public class UploadData8 {
	public static void main(String[] args) {
		...
		//本线程处理1260000-1440000万的数据，共5万数据量
		Integer handerStartIndex=1260000;
		Integer handerDataMaxIndex=1440000;
