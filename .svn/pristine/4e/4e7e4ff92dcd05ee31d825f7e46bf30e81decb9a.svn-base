package com.eebbk.internal.question.convertor.exportjarserviceRebuild03;
...
public class UploadData5 {
	public static void main(String[] args) {
		...
		//本线程处理4320000-4500000万的数据，共5万数据量
		Integer handerStartIndex=4320000;
		Integer handerDataMaxIndex=4500000;
