package com.eebbk.internal.question.convertor.exportjarserviceRebuild02;
...
public class UploadData4 {
	public static void main(String[] args) {
		...
		//本线程处理2340000-2520000万的数据，共5万数据量
		Integer handerStartIndex=2340000;
		Integer handerDataMaxIndex=2520000;
