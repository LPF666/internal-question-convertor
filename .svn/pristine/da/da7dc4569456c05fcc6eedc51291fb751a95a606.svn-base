package com.eebbk.internal.question.convertor.exportjarserviceRebuild07;
...
public class UploadData6 {
	public static void main(String[] args) {
		...
		//本线程处理11700000-11880000万的数据，共5万数据量
		Integer handerStartIndex=11700000;
		Integer handerDataMaxIndex=11880000;
